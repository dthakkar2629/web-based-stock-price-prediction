...
def get_historical_stock_price(stock):
    ...
    # get 12 years stock data
    startDate = datetime.datetime(2008, 1, 4)
    endDate = datetime.datetime(2020, 2, 10)
...
def main():
    if request.method == 'POST':
        ...
        return render_template("plot.html", original=round(original_end, 2), forecast=round(forecast_start, 2),
